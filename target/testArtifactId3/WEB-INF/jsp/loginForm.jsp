...
<body id="page-top">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    <li>
                        <a class="page-scroll" href='<c:url value="/"></c:url>'> Home</a>
                    </li>
                    <li>
    ...
    <header>
        <div class="header-content" id="home">
            ...
            <h2 id="loginPageHeading">Login Page</h2>
            ...
            <div class="row no-gutter popup-gallery">
                ...
                <div class="col-lg-4 col-sm-6">
                    <a href="<c:url value="/resources/img/portfolio/fullsize/2.jpg" />" class="portfolio-box">
                        <img src="<c:url value="/resources/img/portfolio/thumbnails/2.jpg" />" class="img-responsive" alt="">
                        <div class="portfolio-box-caption">
                            <div class="portfolio-box-caption-content">
                                <div class="project-category text-faded">
                                    Category
                ...
                <div class="col-lg-4 col-sm-6">
                    <a href="<c:url value="/resources/img/portfolio/fullsize/3.jpg" />" class="portfolio-box">
                        <img src="<c:url value="/resources/img/portfolio/thumbnails/3.jpg" />" class="img-responsive" alt="">
                        <div class="portfolio-box-caption">
                            <div class="portfolio-box-caption-content">
                                <div class="project-category text-faded">
                                    Category
                ...
                <div class="col-lg-4 col-sm-6">
                    <a href="<c:url value="/resources/img/portfolio/fullsize/4.jpg" />" class="portfolio-box">
                        <img src="<c:url value="/resources/img/portfolio/thumbnails/4.jpg" />" class="img-responsive" alt="">
                        <div class="portfolio-box-caption">
                            <div class="portfolio-box-caption-content">
                                <div class="project-category text-faded">
                                    Category
                ...
                <div class="col-lg-4 col-sm-6">
                    <a href="<c:url value="/resources/img/portfolio/fullsize/5.jpg" />" class="portfolio-box">
                        <img src="<c:url value="/resources/img/portfolio/thumbnails/5.jpg" />" class="img-responsive" alt="">
                        <div class="portfolio-box-caption">
                            <div class="portfolio-box-caption-content">
                                <div class="project-category text-faded">
                                    Category
                ...
                <div class="col-lg-4 col-sm-6">
                    <a href="<c:url value="/resources/img/portfolio/thumbnails/6.jpg" />" class="portfolio-box">
                        <img src="<c:url value="/resources/img/portfolio/thumbnails/6.jpg" />" class="img-responsive" alt="">
                        <div class="portfolio-box-caption">
                            <div class="portfolio-box-caption-content">
                                <div class="project-category text-faded">
                                    Category
